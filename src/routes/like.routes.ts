...
likeRouter.post("/like",validationYup(schemas.likeSchema),LikeController.likeTweet);

likeRouter.post("/dislike",validationYup(schemas.likeSchema),LikeController.dislikeTweet);
